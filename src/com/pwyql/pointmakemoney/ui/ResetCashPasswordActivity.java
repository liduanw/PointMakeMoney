...
import com.pwyql.pointmakemoney.service.AppService.OnResetcashResponseListener;
import com.pwyql.pointmakemoney.service.AppService.OnVerifyPhoneCodeResponseListener;
import com.pwyql.pointmakemoney.service.AppService.ResetCashPwdParams;
...
public class ResetCashPasswordActivity extends BaseActivity {
	...
	setContentView(R.layout.activity_resetcashpwd);
	init();
    }
	...
	ResetCashPwdParams postParams = new ResetCashPwdParams();
	postParams.phoneNumber = lastPhoneNumber;
	postParams.password = lastPwd;
	postParams.token = token;
	AppServiceImpl.getInstance().resetCashPassword(postParams, new OnResetcashResponseListener() {
