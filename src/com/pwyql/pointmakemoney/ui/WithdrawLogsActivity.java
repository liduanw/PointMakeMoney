 ...
 *
 */
public class WithdrawLogsActivity extends BaseActivity {
    WebView mWebView;
	...
	setContentView(R.layout.activity_withdraw_logs);
	...
	mWebView.loadUrl(AppConstants.URL_WITHDRAW_LOGS);
