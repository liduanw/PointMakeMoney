 ...
 *
 */
public class WithdrawFormTenpayActivity extends BaseActivity implements OnClickListener {
	...
	setContentView(R.layout.activity_form_tenpay);
	...
	postParams.sign = StringUtils.md5("" + 3 + priceType + AppConstants.SIGN_KEY);
	AppServiceImpl.getInstance().withdraw(postParams, new OnWithdrawResponseListener() {
		...
		AlertDialog.Builder builder = new AlertDialog.Builder(WithdrawFormTenpayActivity.this);
