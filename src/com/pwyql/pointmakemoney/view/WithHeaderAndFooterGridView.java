 ...
 * See {@link WithHeaderAndFooterGridView#addHeaderView(View, Object, boolean)}
 * See {@link WithHeaderAndFooterGridView#addFooterView(View, Object, boolean)}
 */
public class WithHeaderAndFooterGridView extends GridView {
    ...
    public WithHeaderAndFooterGridView(Context context) {
	super(context);
	initHeaderGridView();
    }

    public WithHeaderAndFooterGridView(Context context, AttributeSet attrs) {
	super(context, attrs);
	initHeaderGridView();
    }

    public WithHeaderAndFooterGridView(Context context, AttributeSet attrs, int defStyle) {
	...
	protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
	    int realLeft = WithHeaderAndFooterGridView.this.getPaddingLeft() + getPaddingLeft();
	...
	@Override
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
	    int targetWidth = WithHeaderAndFooterGridView.this.getMeasuredWidth() - WithHeaderAndFooterGridView.this.getPaddingLeft() - WithHeaderAndFooterGridView.this.getPaddingRight();
