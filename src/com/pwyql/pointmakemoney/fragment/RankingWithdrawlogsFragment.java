...
public class RankingWithdrawlogsFragment extends BaseFragment {
	...
	View view = inflater.inflate(R.layout.fragment_rankingwithdrawlogs, container, false);
	init(view);
	return view;
    }
	...
	mSwipeRefreshLayout.setOnRefreshListener(new android.support.v4.widget.SwipeRefreshLayout.OnRefreshListener() {
		...
		mWebView.loadUrl(AppConstants.URL_RANKINGWITHDRAW_LOGS);
	    }
	});
	// 设置进度条颜色
